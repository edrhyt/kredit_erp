                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form action="<?php echo base_url('so/do_edit_so'); ?>" method="POST" class="needs-validation" novalidate="" accept-charset="utf-8">
                            <div class="input-group">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-4">No SO </label>
                                <input type="text" class="form-control" name="no_surat_order" value="<?=$r['no_surat_order'];?>" readonly="">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                <a href="#" class="btn btn-icon icon-left btn-primary btn-block" data-toggle="modal" data-target="#exampleModalScrollable" onclick="<?= base_url('penjualan/empty_temp_dtl');?>" id="modal_barang"><i class="far fa-edit"></i> Ubah Data Barang</a>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                    ...
                                    <select name="jml_angsuran" id="angsuran" onclick="getAngsuran()" class="form-control selectric">
                                        ...
                                        <?php
                                              if($rows['jml_angsuran'] == '5'){
                                                ...
                                                <option value="9">9 Bulan</option>
                                                <option value="10">10 Bulan</option>';
                                              }elseif($rows['jml_angsuran'] == '8'){
                                                echo'
                                                <option value="5">5 Bulan</option>
                                                <option value="6">6 Bulan</option>
                                                <option value="7">7 Bulan</option>
                                                <option value="8" selected>8 Bulan</option>
                                                <option value="9">9 Bulan</option>
                                                <option value="10">10 Bulan</option>';
                                              }elseif($rows['jml_angsuran'] == '9'){
                                                echo'
                                                <option value="5">5 Bulan</option>
                                                <option value="6">6 Bulan</option>
                                                <option value="7">7 Bulan</option>
                                                <option value="8">8 Bulan</option>
                                                <option value="9" selected>9 Bulan</option>
                                                <option value="10">10 Bulan</option>';
                                              }else{
                                                echo'
                                                <option value="5">5 Bulan</option>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" id="diskon_dp" onkeyup="getTotal()" class="form-control only-number" name="diskon_dp" value="<?=$r['diskon_dp'];?>" required="">
                                    <div class="invalid-feedback">
                                        Silahkan lengkapi telebih dahulu
                                    </div>
                                </div>
                            ...
                            <div class="form-group row mb-4" id="form1">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" id="text-box1" name="hadiah" value="<?=$r['hadiah'];?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4" id="form2">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control only-number" id="text-box2" onkeyup="getNetto()" name="diskon_koordinator" value="<?=$r['diskon_koordinator'];?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="total" value="<?=$r['total'];?>" id="total_angsuran" required="" placeholder="Total Angsuran" readonly="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Netto</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="number" class="form-control" name="netto" value="<?=$r['netto'];?>" id="netto" readonly="">
                                </div>
                            </div>
                             <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Angsuran 1</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="angsuran1" value="<?=$r['angsuran1'];?>" id="total_dp" placeholder="Angsuran 1" readonly="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Angsuran/Bulan</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="angsuran_bln" value="<?=$r['angsuran_bln'];?>" id="angsuran_bln" placeholder="Angsuran/Bulan" readonly="">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-4">
                                    <div class="thumbnail">
                                        <div class="caption">
                                            ...
                                            <button type="button" id="btn_dtl" class="add_cart btn btn-success btn-block" data-idbarang="<?php echo $row->id_barang;?>" data-namabarang="<?php echo $row->nama_barang;?>" data-harga="<?php echo $row->harga;?>">Add To Cart</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
