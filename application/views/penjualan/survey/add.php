<section class="section">
        <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo base_url('survey');?>">Data Surat Order</a></div>
            <div class="breadcrumb-item"><?= $breadcrumb; ?></div>
          </div>
        </div>
        <div class="section-body">
          <h2 class="section-title">Form Tambah Data Survey</h2>
          <p class="section-lead">
            halaman ini berisi Formulir Tambah Data Survey.
          </p>
        </div>
  </section>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <form action="<?php echo base_url('survey/do_add_survey'); ?>" method="POST" class="needs-validation" novalidate="" accept-charset="utf-8">
                                <input type="hidden" value="<?=$r['id_surat_order'];?>" name="id_surat_order">
                                <input type="hidden" value="<?=$r['kode_detail'];?>" name="kode_detail">
                    ...
                    <div class="card-body">
                            <div class="form-group row mb-4">
                              ...
                              <div class="col-sm-12 col-md-3">
                                <input type="date" class="btn btn-primary daterange-btn icon-left btn-icon" name="tgl_s" value="<?=$r['tgl_s'];?>" required="" >
                              </div>
                              <div class="invalid-feedback">
                                  Silahkan lengkapi telebih dahulu
                                </div>
                              ...
                              <div class="col-sm-12 col-md-3">
                                <input type="date" class="btn btn-primary daterange-btn icon-left btn-icon" name="tgl_k" value="<?=$r['tgl_k'];?>" required="" >
                              </div>
                              <div class="invalid-feedback">
                                  Silahkan lengkapi telebih dahulu
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7" >
                                    <select name="kab" id="kab" class="form-control selectric kabupaten" >
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-2">
                                    <select name="tgl_tempo" class="form-control selectric">
                                       <?php
                                        for ($i=1; $i<=31; $i++)
                                        {
                                            ?>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control only-number" name="no_telp" required="">
                                    <div class="invalid-feedback">
                                        Silahkan lengkapi telebih dahulu
                                    </div>
                                </div>
                            ...
                            <div class="form-group row mb-4">
                              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Surveyor</label>
                              <div class="col-sm-12 col-md-7" >
                                  <select name="surveyor" class="form-control selectric">
                                      <option value="0" selected disabled="">Pilih Surveyor</option>
                                      <?php foreach($surveyor->result() as $row):?>
