<section class="section">
    <div class="section-header">
        ...
        <h1>Data Verifikasi <?=$r['no_surat_order'];?></h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo base_url('admin');?>">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="<?php echo base_url('survey');?>">Data Survey</a></div>
            <div class="breadcrumb-item">Lihat Data Verifikasi</div>
        </div>
    </div>
    <div class="section-body">
        <h2 class="section-title">Lihat Data Verifikasi</h2>
        <p class="section-lead">
            Di halaman ini berisi Data Verifikasi dengan Kode <?=$r['no_surat_order'];?>
        </p>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url('verifikasi/do_verifikasi'); ?>" method="POST" accept-charset="utf-8">
                        ...
                        <center>
                                 <button class="btn btn-primary" type="submit" name="terima">Terima Permintaan</button>
                                 <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?=$r['kode_detail'];?>">Tolak Permintaan</button>
                                 <button class="btn btn-secondary" data-toggle="modal" data-target="#ModalBatal<?=$r['kode_detail'];?>">Batal Permintaan</button>
                        </center>
                    </div>
...
<?php
 ...
 foreach ($record_verifikasi as $r)
 {
    $i++;
?>
 <form action="<?php echo base_url('verifikasi/do_verifikasi'); ?>" method="POST" accept-charset="utf-8">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home<?= $i;?>" role="tabpanel"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea class="form-control almt" name="keterangan1" required=""></textarea>
                                </div>
                            </div>
                        </div>
