...
class M_barang extends CI_Model
{
    ...
    {
        return $this->db->get('tb_inventory_barang')->result_array();
    }

    // public function getBarangMasuk()
    // {
    //     $this->db->join('tb_inventory_barang b', 'bm.barang_id = b.id_barang');
    //     return $this->db->get('tb_inventory_barang b')->result_array();
    // }
    ...
    public function getBarangMasuk($limit = null, $id_barang = null, $range = null)
    {
        ...
        return $this->db->get('tb_inventory_masuk bm')->result_array();
    }
    ...
    public function getBarangKeluar($limit = null, $id_barang = null, $range = null)
    {
        ...
        return $this->db->get('tb_inventory_keluar bm')->result_array();
    }
    ...
    {
        $this->db->join('satuan s', 'b.satuan_id=s.id_satuan');
        return $this->db->get_where('tb_inventory_barang b', ['id_barang' => $id])->row_array();
    }
}
